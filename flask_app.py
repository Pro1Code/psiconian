...
# =========================
# FUNCIÓN PARA EMAIL DE BIENVENIDA (COMPLETA)
# =========================
                    ...
                    <body>
                        <div class="container">
                            ...
                            <div class="content">
                                ...
                                <p>Nos alegra muchísimo que formes parte de nuestra comunidad. En Mian, queremos acompañarte en tu camino hacia el bienestar mental y el autoconocimiento.</p>
                                
                                <h3>🔹 Tu espacio personal incluye:</h3>
                                
                                <div class="feature">
                                    <strong>🧠 Ejercicios de neuropsicología</strong><br>
                                    Personalizados según tu nivel y objetivos
                                </div>
                                
                                <div class="feature">
                                    <strong>📊 Seguimiento de progreso</strong><br>
                                    Visualiza tu evolución con gráficos y estadísticas
                                </div>
                                ...
                                <ol>
                                    ...
                                    <li>Realiza tu primer ejercicio del día</li>
                                    <li>Explora la biblioteca de recursos</li>
                                </ol>
                                
                                <p>Si tienes cualquier duda, responde a este email. Estamos aquí para ayudarte.</p>
                                
                                <p>Un abrazo,<br>
                                <strong>El equipo de Mian</strong></p>
                            </div>
                            <div class="footer">
                                <p>© 2025 Mian - Neuropsicología & Bienestar. Todos los derechos reservados.</p>
                            </div>
                        </div>
                    </body>
                    </html>
...
# =========================
# FUNCIÓN PARA EMAIL DE RECUPERACIÓN (COMPLETA)
# =========================
    ...
    def send_email_thread():
        with app.app_context():
            try:
                ...
                msg = Message(
                    subject="🔐 Recupera tu contraseña - Mian",
                    recipients=[user_email],
                    html=f"""
                    <!DOCTYPE html>
                    <html>
                    ...
                    <body>
                        <div class="container">
                            ...
                            <div class="content">
                                <h2>Hola {safe_name},</h2>
                                <p>Recibimos una solicitud para restablecer tu contraseña en Mian.</p>
                            ...
                            <div class="footer">
                                <p>© 2025 Mian - Neuropsicología & Bienestar</p>
                            </div>
                        </div>
                    </body>
                    </html>
                ...
                print(f"📧 Enviando email de recuperación a: {user_email}")
                mail.send(msg)
...
def admin_panel():
    ...
    if not user or not user[0]:
        # Mensaje amigable para usuarios no admin (VERSIÓN COMPLETA)
        return """
        <!DOCTYPE html>
        <html>
        <head>
            ...
            <style>
                ...
                h1 { color: #0B2A4A; margin-bottom: 1rem; font-size: 2rem; }
                p { color: #7C8A9A; margin-bottom: 2rem; line-height: 1.6; }
...
def check_env():
    ...
    admin_status = session.get('is_admin', 'NO LOGUEADO')
    return f"""
    <h2>🔍 Diagnóstico</h2>
    <p><strong>MAIL_USERNAME:</strong> {username}</p>
    <p><strong>MAIL_PASSWORD:</strong> {password}</p>
    <p><strong>Admin status:</strong> {admin_status}</p>
...
def ratelimit_handler(e):
    return jsonify({"message": "Demasiados intentos. Intenta nuevamente en unos minutos."}), 429
